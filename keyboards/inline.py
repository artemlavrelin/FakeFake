...
def main_menu_keyboard() -> InlineKeyboardMarkup:
    ...
    builder.row(InlineKeyboardButton(text="⭐️ Выплаты / Отзывы", callback_data="report"))
    builder.row(
...
def atm_main_keyboard(has_data: bool) -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
...
def atm_confirm_keyboard() -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
    builder.row(
        InlineKeyboardButton(text="✅ Сохранить", callback_data="atm_save"),
...
def admin_panel_keyboard(has_active: bool) -> InlineKeyboardMarkup:
    ...
    # Back button — returns to main user menu
